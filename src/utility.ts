import {AutocompleteInteraction, ImageURLOptions, Interaction, InteractionType, TextChannel, inlineCode, APIEmbed, APIApplicationCommandOptionChoice, EmbedBuilder, BaseInteraction, blockQuote, ButtonInteraction, ModalSubmitInteraction} from "discord.js";
...
/**
 * Function used to filter non-setting values from the guild settings schema.
 * @param {Schema} schema 
 * @returns {APIApplicationCommandOptionChoice[]}
 */
...
/**
 * Different setting types for guild settings system.
 */
